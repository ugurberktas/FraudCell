...
Gamification and analyst reward engine scaffold for FraudCell.
...
| `GET` | `/ready` | Readiness check (Executes `SELECT 1` on `gamification-db`) | `200 OK` (connected) / `503 Service Unavailable` |

## Environment Variables

| Variable | Default | Description |
|---|---|---|
| `SERVICE_NAME` | `gamification-service` | Service identifier |
